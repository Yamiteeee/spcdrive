  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#f7faf8] text-slate-900">
      ...
      <div className="absolute inset-0 bg-linear-to-b from-white/80 via-white/90 to-[#f7faf8]" />
        ...
        {/* Fixed: top-[-220px] -> -top-55 (approx) or keep as is if specific, but h/w fixed to h-150 */}
        <div className="absolute left-1/2 -top-56 h-150 w-150 -translate-x-1/2 rounded-full bg-emerald-200/30 blur-3xl" />
        
        {/* Fixed: bottom-[-200px] -> -bottom-50 | right-[-100px] -> -right-25 | h/w-[500px] -> h-125/w-125 */}
        ...
        >
          <div className="grid items-center gap-20 lg:grid-cols-2">
            ...
            <div className="relative">
              ...
              <div className="overflow-hidden rounded-4xl border border-white bg-white/90 p-7 shadow-xl">
                ...
                <div className="mt-6 space-y-4">
                  {[
                    ...
                    <div
                      key={i}
                      className="flex gap-4 rounded-2xl bg-slate-50 p-5 hover:bg-emerald-50 transition-colors"
                    >
